...
describe ApplicationHelper do
  ...
  #       it "is true for this old Android browser" do
  #         controller.request.stubs(:user_agent).returns("Mozilla/5.0 (Linux; U; Android 4.1.1; en-us; Android SDK built for x86 Build/JRO03H) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Safari/534.30")
  #         helper.mobile_view?.should eq(true)
  #       end
  #     end
  #   end
